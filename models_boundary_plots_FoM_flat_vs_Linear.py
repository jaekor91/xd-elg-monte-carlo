...
print "Generate intrinsic sample using Linear_redz FoM option."
instance_model.set_FoM_option("Linear_redz")       
instance_model.gen_sample_intrinsic()
...
for i in range(3):
    instance_model.gen_select_boundary_slices(slice_dir = i, model_tag="model3", cv_tag="Full-typical-flat-vs-Linear",\
