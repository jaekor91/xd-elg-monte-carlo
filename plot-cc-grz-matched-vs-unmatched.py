...
plt.savefig("cc-grz-DR5-to-DEEp2-matched-vs-unmatched-glim24.png", dpi=200, bbox_inches="tight")
# plt.show()
plt.close()
...
plt.savefig("cc-grz-DR5-to-DEEp2-matched-vs-unmatched-glim25.png", dpi=200, bbox_inches="tight")
# plt.show()
plt.close()